...
public interface AdminService {
	...
	public void updateCompany(@NotNull(message="Updated company cannot be null. ") @Valid Company company, long id) throws IncompatibleInputException, ObjectNotFoundException;
	...
	public void updateCustomer(@NotNull(message="Updated customer cannot be null. ") @Valid Customer customer ) throws ObjectNotFoundException, IncompatibleInputException;
